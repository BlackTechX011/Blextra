...
👋 Hello! Welcome to the Blextra documentation!

<!--more-->

## What is Blextra?

Blextra is a modern, fast and batteries-included [Hugo][hugo] theme built with [Tailwind CSS][tailwind-css].
...
{{< callout emoji="❓" >}}
  Blextra is still in active development.
  Have a question or feedback? Feel free to [open an issue](https://github.com/BlackTechX011/Blextra/issues)!
{{< /callout >}}
...
{{< cards >}}
  {{< card link="getting-started" title="Getting Started" icon="document-text" subtitle="Learn how to create website using Blextra" >}}
{{< /cards >}}
