---
title: Customizing Blextra
linkTitle: Customization
---

Blextra offers some default customization options in the `hugo.yaml` config file to configure the theme.
...
To add custom CSS, we need to create a file `assets/css/custom.css` in our site. Blextra will automatically load this file.
...
Didn't find what you were looking for? Feel free to [open a discussion](https://github.com/BlackTechX011/Blextra/discussions) or make a contribution to the theme!
