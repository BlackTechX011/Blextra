...
[🌐 Demo ↗](https://BlackTechX011.github.io/Blextra-starter-template/)
...
2. **Git Submodule**: Alternatively, add Blextra as a [Git Submodule](https://git-scm.com/book/en/v2/Git-Tools-Submodules). The theme is downloaded by Git and stored in your project's `themes` folder.
...
To update Blextra to the [latest released version](https://github.com/BlackTechX011/Blextra/releases), run the following command:
